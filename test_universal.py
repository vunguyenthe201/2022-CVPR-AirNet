...
if __name__ == '__main__':
    ...
    # Make network
    net = AirNet(testopt).cuda()
    net.eval()
    net.load_state_dict(torch.load(ckpt_path, map_location=torch.device(testopt.cuda)))
    ...
    for test_loader in test_loaders:
        ...
        dataset_dir = os.path.join("/workspace/vunt/2022-CVPR-AirNet/results", test_set_name)
        ...
        for i, test_data in tqdm(enumerate(test_loader)):
            ...
            with torch.no_grad():
                ...
                restored = net(x_query=LQ, x_key=LQ)
