...
parser.add_argument('--ckpt_path', type=str, default="ckpt/Decode/", help='checkpoint save path')
parser.add_argument('--continue_ckpt', type=str, default=None, help='continue training from this checkpoint')
